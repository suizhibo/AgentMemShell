...
import xxxx.javassist.bytecode.ClassFile;
import xxxx.javassist.bytecode.Descriptor;
import xxxx.javassist.bytecode.Opcode;
import xxxx.javassist.expr.ExprEditor;
...
public abstract class CtClass {
     ...
     *
     * <pre>java -jar xxxx.javassist.jar</pre>
     */
     ...
     */
    public xxxx.javassist.compiler.AccessorMaker getAccessorMaker() {
        return null;
    }
     ...
     * @see xxxx.javassist.bytecode.SignatureAttribute#toClassSignature(String)
     ...
     * @see xxxx.javassist.bytecode.SignatureAttribute.ClassSignature#encode()
     * @see xxxx.javassist.bytecode.SignatureAttribute.MethodSignature#encode()
     ...
     * For decoding, use <code>xxxx.javassist.Modifier</code>.
     *
     ...
     *                  <code>xxxx.javassist.Modifier</code>
     * @see Modifier
     */
     ...
     * or <code>xxxx.javassist.bytecode.Descriptor</code>.
     *
     ...
     * <code>xxxx.javassist.bytecode</code> package.  For example, the following
     ...
     * @see xxxx.javassist.bytecode.AttributeInfo
     */
