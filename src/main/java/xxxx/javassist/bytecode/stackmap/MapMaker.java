...
import xxxx.javassist.bytecode.*;
...
public class MapMaker extends Tracer {
    ...
    public static void main1(String className) throws Exception {
        ...
        //xxxx.javassist.CtClass cc = cp.get(className);
        xxxx.javassist.CtClass cc = cp.makeClass(new java.io.FileInputStream(className));
    ...
    public static void main2(String[] args) throws Exception {
        ClassPool cp = ClassPool.getDefault();
        //xxxx.javassist.CtClass cc = cp.get(args[1]);
        xxxx.javassist.CtClass cc = cp.makeClass(new java.io.FileInputStream(args[1]));
        MethodInfo minfo;
    ...
    */
     ...
     * See xxxx.javassist.JvstTest4.testJIRA195().
     */
