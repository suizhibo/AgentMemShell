...
public class StubGenerator implements Translator {
    ...
    private static final String sampleClass = "xxxx.javassist.tools.rmi.Sample";
     ...
     * This is a method declared in xxxx.javassist.Translator.
     *
    ...
    public void start(ClassPool pool) throws NotFoundException {
        ...
        proxyConstructorParamTypes
            = pool.get(new String[] { "xxxx.javassist.tools.rmi.ObjectImporter",
                                         "int" });
        interfacesForProxy
            = pool.get(new String[] { "java.io.Serializable",
                                         "xxxx.javassist.tools.rmi.Proxy" });
        exceptionForProxy
            = new CtClass[] { pool.get("xxxx.javassist.tools.rmi.RemoteException") };
    }
        ...
        throws CannotCompileException, NotFoundException
    {
        ...
        CtField f
            = new CtField(classPool.get("xxxx.javassist.tools.rmi.ObjectImporter"),
                          fieldImporter, proxy);
