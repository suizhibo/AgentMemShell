...
import xxxx.javassist.CannotCompileException;
import xxxx.javassist.ClassPool;
import xxxx.javassist.NotFoundException;
 ...
 *     xxxx.javassist.tools.reflect.Loader cl
 *         = (xxxx.javassist.tools.reflect.Loader)Main.class.getClassLoader();
 *     cl.makeReflective("Person", "MyMetaobject",
 *                       "xxxx.javassist.tools.reflect.ClassMetaobject");
 *     cl.run("MyApp", args);
 *   }
 * }
 * </pre>
 ...
 *
 * <pre>% java xxxx.javassist.tools.reflect.Loader Main arg1, ...</pre>
 *
 ...
 * public class Main2 {
 *   public static void main(String[] args) throws Throwable {
 *     xxxx.javassist.tools.reflect.Loader cl = new xxxx.javassist.tools.reflect.Loader();
 *     cl.makeReflective("Person", "MyMetaobject",
 *                       "xxxx.javassist.tools.reflect.ClassMetaobject");
 *     cl.run("MyApp", args);
 *   }
 ...
 * is loaded by <code>xxxx.javassist.tools.reflect.Loader</code> whereas the class
 ...
 * to the same name space as <code>xxxx.javassist.tools.reflect.Loader</code>.
 * For more details,
 * see the notes in the manual page of <code>xxxx.javassist.Loader</code>.
 *
 ...
 *     xxxx.javassist.Loader cl
 *         = new xxxx.javassist.Loader(ClassPool.getDefault(reflection));
 ...
 * <p><b>Note:</b>
 *
 * <p><code>xxxx.javassist.tools.reflect.Loader</code> does not make a class reflective
 ...
 * modified with <code>xxxx.javassist.tools.reflect.Compiler</code> and the original
 * class files should be replaced.
 *
 * @see Reflection
 * @see Compiler
 * @see xxxx.javassist.Loader
 */
public class Loader extends xxxx.javassist.Loader {
    ...
    public Loader() throws CannotCompileException, NotFoundException {
        super();
        delegateLoadingOf("xxxx.javassist.tools.reflect.Loader");
