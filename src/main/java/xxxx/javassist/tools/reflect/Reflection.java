...
import xxxx.javassist.CtMethod.ConstParameter;
import xxxx.javassist.bytecode.BadBytecode;
import xxxx.javassist.bytecode.ClassFile;
import xxxx.javassist.bytecode.MethodInfo;
...
public class Reflection implements Translator {
    ...
    static final String metaobjectClassName = "xxxx.javassist.tools.reflect.Metaobject";
    ...
    public void start(ClassPool pool) throws NotFoundException {
        classPool = pool;
        final String msg
            = "xxxx.javassist.tools.reflect.Sample is not found or broken.";
        try {
            CtClass c = classPool.get("xxxx.javassist.tools.reflect.Sample");
        ...
        throws CannotCompileException, NotFoundException
    {
        ...
        CtClass mlevel = classPool.get("xxxx.javassist.tools.reflect.Metalevel");
        ...
        CtField f;
        if (addMeta) {
            f = new CtField(classPool.get("xxxx.javassist.tools.reflect.Metaobject"),
        ...
        f = new CtField(classPool.get("xxxx.javassist.tools.reflect.ClassMetaobject"),
