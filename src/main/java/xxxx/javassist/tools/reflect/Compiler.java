 ...
 * without <code>xxxx.javassist.tools.reflect.Loader</code>
...
public class Compiler {
        ...
        throws Exception
    {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            if (entries[i].metaobject != null
                ...
                if (entries[i].metaobject == null)
                    metaobj = "xxxx.javassist.tools.reflect.Metaobject";
                else
                    metaobj = entries[i].metaobject;

                if (entries[i].classobject == null)
                    classobj = "xxxx.javassist.tools.reflect.ClassMetaobject";
                else
    ...
    private static void help(PrintStream out) {
        out.println("Usage: java xxxx.javassist.tools.reflect.Compiler");
