...
public abstract class CtBehavior extends CtMember {
     ...
     * such as <code>xxxx.javassist.CtBehavior.stBody(String)</code>.
     *
     * @since 3.5
     */
     ...
     * <code>xxxx.javassist.runtime.Cflow</code> at runtime
     ...
     *
     * @see xxxx.javassist.runtime.Cflow
     */
    public void useCflow(String name) throws CannotCompileException {
        ...
        try {
            CtClass type = pool.get("xxxx.javassist.runtime.Cflow");
     ...
     * @see xxxx.javassist.expr.Expr#replace(String)
     * @see #insertBefore(String)
     */
