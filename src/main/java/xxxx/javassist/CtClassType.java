...
import xxxx.javassist.bytecode.annotation.Annotation;
import xxxx.javassist.compiler.AccessorMaker;
import xxxx.javassist.compiler.CompileError;
import xxxx.javassist.compiler.Javac;
...
class CtClassType extends CtClass {
    ...
    *
    * @see xxxx.javassist.CtClass#incGetCounter()
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    return xxxx.javassist.bytecode.annotation.AnnotationImpl.make(
