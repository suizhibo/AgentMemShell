...
import xxxx.javassist.CtClass;
import xxxx.javassist.CtPrimitiveType;
import xxxx.javassist.NotFoundException;
import xxxx.javassist.bytecode.Bytecode;
import xxxx.javassist.bytecode.Descriptor;
import xxxx.javassist.compiler.ast.*;
...
public class JvstCodeGen extends MemberCodeGen {
    ...
    public void atMember(Member mem) throws CompileError {
        ...
        if (name.equals(paramArrayName)) {
            ...
            bytecode.addInvokestatic("xxxx.javassist/runtime/Desc", "getParams",
    ...
    private void callGetType(String method) {
        bytecode.addInvokestatic("xxxx.javassist/runtime/Desc", method,
                                "(Ljava/lang/String;)Ljava/lang/Class;");
        exprType = CLASS;
        arrayDim = 0;
        className = "java/lang/Class";
    ...
    protected void atCflow(ASTList cname) throws CompileError {
        ...
        bytecode.addInvokevirtual("xxxx.javassist.runtime.Cflow",
                                  "value", "()I");
        exprType = INT;
        arrayDim = 0;
        className = null;
